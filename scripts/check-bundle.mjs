...
const budgets = {
  // Wave 1 adds a small static metadata/guide surface; keep a narrow 46 KB entry budget.
  entryGzip: 46 * 1024,
...
if (entry.gzip > budgets.entryGzip) throw new Error('Entry bundle เกินงบ 46 KB gzip');
