...
const budgets = {
  // The static catalog now carries seven additional bilingual metadata/guide entries; keep measured headroom at 56 KB while lazy-loading implementations.
  entryGzip: 56 * 1024,
...
if (entry.gzip > budgets.entryGzip) throw new Error('Entry bundle เกินงบ 56 KB gzip');
