...
describe('PWA assets', () => {
  ...
  it('supports versioned shell and per-tool offline caches', () => {
    ...
    expect(serviceWorker).toContain('utility-hub-shell-v0.8.1-home-personalization');
    expect(serviceWorker).toContain('utility-hub-tools-v0.8.1-home-personalization');
